 ...
 * @author Victor
 */
public class newConsultaArea extends javax.swing.JPanel {
     ...
     */
    public newConsultaArea() throws ParseException {
        initComponents();
        areas = new ArrayList<>();
...
//
        ...
        newLabel4.setText("Descrição:");
        newLabel4.setFont(new Font("Tahoma", 0, 18));
        newLabel4.setVisible(true);
        this.add(newLabel4, new AbsoluteConstraints(200, 205));
        descricaoField = new JTextField();
        descricaoField.setVisible(true);
        this.add(descricaoField, new AbsoluteConstraints(280, 205, 200, 25));
...
//        this.add(idField, new AbsoluteConstraints(800, 100, 60, 25));
        ...
        this.add(newLabel5, new AbsoluteConstraints(700, 135));
        descFieldConsulta = new JTextField();
        descFieldConsulta.setVisible(true);
        this.add(descFieldConsulta, new AbsoluteConstraints(800, 135, 200, 25));
    ...
    private void pesquisarButtonPerformed(java.awt.event.ActionEvent evt) throws SQLException {
        String query = "SELECT * FROM area WHERE ";
        ...
        if (!descFieldConsulta.getText().equals("")) {
            query = query + "descricao='" + descFieldConsulta.getText() + "'";
        }
        if ((!datainicial.equals("") && datafinal.equals("")) || (datainicial.equals("") && !datafinal.equals(""))) {
            ...
            if (datainicial.equals("")) {
                if (descFieldConsulta.getText().equals("") && evt != null) {
                    JOptionPane.showMessageDialog(null,
                ...
                if (query.equals("SELECT * FROM area WHERE ")) {
        ...
        if (query.equals("SELECT * FROM area WHERE ")) {
            ...
            Component teste = SwingUtilities.getWindowAncestor(buttonCadastro);
            mainFrame a = (mainFrame) teste;
            areas = a.consultaAreaQuery(query);
    ...
    private void preperajtable() throws SQLException {
        ...
        jTable2.setModel(new jtableArea(new String[]{
            "Codigo", "Nome", "Data"
        }, areas.size()));
        limpatable();
        ...
        for (int i = 0; i < jTable2.getRowCount(); i++) {
            ...
            for (int j = 0; j <= 2; j++) {
                ...
                if (!dado.equals(String.valueOf(jTable2.getValueAt(i, j)))) {
                    ...
                    switch (j) {
                        case 0:
                            areas.get(i).setCodigo(Integer.valueOf((String) jTable2.getValueAt(i, j)));
                            break;
                        case 1:
...
//        buttonExportar.setVisible(false);
    ...
    private void buttonCadastroPerformed(ActionEvent evt) throws SQLException {
        Component teste = SwingUtilities.getWindowAncestor(buttonCadastro);
        mainFrame a = (mainFrame) teste;
        a.cadastroAreaDAO(descricaoField.getText());
        area retorno = a.consultaArea(descricaoField.getText());
        if (retorno != null) {
            areas.add(retorno);
            preperajtable();
        }
    ...
    private void deleteActionPerformed(ActionEvent evt) throws SQLException {
        ...
        String query = "DELETE FROM area WHERE id IN (";
    ...
    private void trocaEmpresaPerformed(ActionEvent evt) throws ParseException {
        Component teste = SwingUtilities.getWindowAncestor(buttonCadastro);
        mainFrame a = (mainFrame) teste;
        a.switchPanels(3);
    }
